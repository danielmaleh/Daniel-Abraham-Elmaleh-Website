...
export const ProjectsData: Project[] = [
    ...
    {
        slug: "semiconductor-nanowires",
        title: "Semiconductor Nanowire Characterization",
        course: "LMSC Lab - Prof. Anna Fontcuberta i Morral",
        timeline: "2023",
        summary: "Research on semiconductor nanowires with development of analytical software for data analysis.",
        description:
            "Research internship at EPFL's Laboratory of Semi-Conductor Materials characterizing semiconductor nanowires. Developed analytical software in Python for results and data analysis, working on advanced characterization techniques for nanoscale semiconductor structures.",
        highlights: [
            "Characterized semiconductor nanowire structures.",
            "Developed Python analysis tools for measurement data.",
            "Applied advanced microscopy and spectroscopy techniques.",
            "Analyzed growth parameters and material properties.",
        ],
        tags: ["Nanotechnology", "Photonics", "Signal Processing"],
        resources: [
            {
                type: "code",
                label: "Source Code",
