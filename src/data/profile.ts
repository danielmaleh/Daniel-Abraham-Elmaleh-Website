...
export const UserInfo = {
    ...
    biography: `
        ...
        <div class="my-2"></div>
        With a Bachelor's in Micro-engineering from EPFL and an exchange year at École Polytechnique de Paris, I have hands-on experience in clean room fabrication, optical setups, and software development. I speak English (C2), French (native), and Hebrew (native).
        <div class="my-2"></div>
        Outside of science and engineering, I enjoy cinema, tennis, skiing, philosophy, nature and classical & jazz music. Thanks for visiting! Feel free to <a href="mailto:daniel1496@gmail.com" target="_blank" rel="noopener noreferrer">get in touch</a> if you'd like to connect.
    `
}
